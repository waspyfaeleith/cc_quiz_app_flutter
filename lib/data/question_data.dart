...
['To hold small chunks of code that can be invoked later on in our program', 'To hold lots of code that does many things which can be invoked later on in our program', 'To hold code we aren’t sure we want to use just yet']);
...
['As many arguments that the function is expecting', 'One argument only', 'As many as we like']);
final question5 = Question('How many parameters can be set for a function?', 'As many as we need', [ 'As many as we need', 'One parameter only', 'A maximum of 10 parameters']);
